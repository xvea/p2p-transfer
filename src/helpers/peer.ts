...
import { setUploadProgress } from '@/store/peer/peerActions'
...
export const PeerConnection = {
  ...
  startPeerSession: () =>
    new Promise<string>((resolve, reject) => {
      try {
        peer = new Peer(nanoid(10))
        peer
          .on('open', (id) => {
            if (id === null || id === undefined) {
              reject(new Error("Invalid ID generated"))
              return
            }
  ...
  sendConnection: (id: string, data: Data, dispatch: Dispatch<any>): Promise<void> =>
